                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <section class="panel">
						     ...
						     <a href="add_home_categories_slider_list.php"><button type="button" class="btn btn-danger" style="float: right;">Add home categories slider</button></a> 
                            </header>
...
<script src="js/pagenation_all_categories_slider_list.js" type="text/javascript"></script>
