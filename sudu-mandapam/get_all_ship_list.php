...
if($search_val!=""){
 $wherecaseselect = " and fpc.doctor_id='".$search_val."' "; 
	...
	$query = "SELECT `id`, `ship_type`, `cost`, `status` FROM `tbl_shipment` where id!='' order by id ASC";
...
while($result = mysqli_fetch_array($result_final)){
        ...
        <tr>
          ...
          ?></td>
          <td> <a href="add_shippment.php?editId=<?php echo $id; ?>">Edit</a> | <a href="javascript:void(0);" onclick="deleteShippment(<?php echo $id; ?>);">Delete</a></td>
      </tr>
