                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            All Category Specification List
                            <a href="add-category-specification.php"><button type="button" class="btn btn-danger" style="float: right; margin-right: 10px;">Add Specification</button></a>
...
<script src="js/pagination_all_cat_specification.js" type="text/javascript"></script>
