...
$editVal = editHomeGategoryBlogValue($edit_id);
?>
<!DOCTYPE html>
<html>
   <!-- header style start-->
                      ...
                      <div class="col-lg-12">
                          <section class="panel">
                              <header class="panel-heading">
                               ...
                               <div class="col-lg-8">
                                  <form class="form-horizontal" method="post" action="get_home_category_blog_add.php" role="form" id="addcates" name="addcates" onsubmit="SaveInfo();"  enctype="multipart/form-data">
                                  <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">home blog image</label>
                                          <div class="col-lg-8">                                      
											<?php if($editVal!=""){ ?>
                                       ...
                                       <div class="form-group">
                                          <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">home blog link name</label>
                                          <div class="col-lg-8">                                      
											<input type="text" id="blog_name" name="blog_name" class="form-control m-b-10" value="<?php echo $editVal['blog_name']; ?>" placeholder="blog link name" >
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">home blog link name</label>
                                          <div class="col-lg-8">                                      
											<textarea id="blog_link" name="blog_link" placeholder="blog link"  class="form-control m-b-10" ><?php echo $editVal['blog_link']; ?></textarea>
                                          </div>
                                      </div>
                                       <div class="form-group">
