                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            All Gift Voucher List
                            <a href="add_gift_voucher.php"><button type="button" class="btn btn-danger" style="float: right; margin-right: 10px;">Add Gift Voucher</button></a>
...
<script src="js/pagenation_all_gift-voucher.js" type="text/javascript"></script>
