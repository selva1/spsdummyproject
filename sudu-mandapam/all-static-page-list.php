                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading">
                                  All Static Pages
                                   <a href="add-static-page.php"><button type="button" class="btn btn-danger" style="float: right; margin-right: 10px;">Add Page</button></a> 
...
<script src="js/pagenation_all_static_page_list.js" type="text/javascript"></script>
