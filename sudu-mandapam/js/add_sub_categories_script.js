...
function SaveInfo() {	
  if($("#addcates").valid()) {
	...
	var subcategory			  =   jQuery.trim($("input[name='subcategory']").val());
	...
	var checkboxes			  =	  "";
	$.post("ajax_all_add_edits.php" , {command:'addSubCategory',category:category,title:title,keyword:keyword,
	description:description,links:links,mainselect:mainselect,status:status,editid:editid,subcategory:subcategory,maindescription:maindescription} , function(data,status)	{
