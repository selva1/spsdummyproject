                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading">
                                  All User List 
                                 <!--   <a href="add_user.php"><button type="button" class="btn btn-danger" style="float: right; margin-right: 10px;">Add User</button></a>  -->
...
<script src="js/pagenation_all_user_list.js" type="text/javascript"></script>
