                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            All Mobile Images
                            <a href="add_mobile_image.php"><button type="button" class="btn btn-danger" style="float: right;">Add Mobile Image</button></a>
                        </header>
...
<script src="js/pagination_all_mobile-images.js" type="text/javascript"></script>
...
<script>
    function deleteImgs(delId){
        ...
        if(x=="1"){
            ...
            $.post("get_delete_mobile_image.php" , {command:'deleteMobileImg',delId:delId} , function(data,status)	{
                if(jQuery.trim(data) == "true"){
                    window.location=site_url+"all-mobile-images.php";
                }
            });
        }
