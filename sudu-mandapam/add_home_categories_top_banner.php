...
$editVal = editHomeGategoryTopBanners($edit_id);
?>
<!DOCTYPE html>
<html>
   <!-- header style start-->
                      ...
                      <div class="col-lg-12">
                          <section class="panel">
                              <header class="panel-heading">
                                   Home Category Top Banner  add /edit
                              </header>
                               ...
                               <div class="col-lg-8">
                                  <form class="form-horizontal" method="post" action="get-home-category-top-banner-add.php" role="form" id="addcates" name="addcates" onsubmit="SaveInfo();"  enctype="multipart/form-data">
                                  
                                  <div class="form-group">
                                          <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">Title</label>
                                          <div class="col-lg-8">
                                             <input type="text" id="title" name="title" class="form-control" value="<?php echo $editVal['title'];  ?>" >
                                      ...
                                      <div class="form-group">
                                          <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">Order by</label>
                                          <div class="col-lg-8">
                                             <input type="text" id="orderby" name="orderby" class="form-control" value="<?php echo $editVal['orderby'];  ?>" >
                                              <p class="help-block"></p>
                                          </div>
                                      </div>
                                          ...
                                          <div class="col-lg-8">
                                              <select class="form-control m-b-10" id="categories" name="categories">
                                                  <option value="">select category name</option>
													...
													if($editVal['categories_id']==$value['category_id']){
													$selected= "selected=''";
													}else{
													$selected ="";
													}
