...
<!-- header style start-->
    <body class="skin-black">
                                  ...
                                  <form class="form-horizontal" role="form" id="addcates" name="addcates">
                                    <div class="form-group" style="display:none;">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-8">
                                             <select id="category" name="category" class="form-control m-b-10">
                                             	<option value="">select category name</option>
                                            	 <option value="<?php echo $editVal['parent_id']; ?>" selected=""><?php echo getgaties($editVal['parent_id']); ?></option>
                                             </select>
                                              <p class="help-block"></p>
                                          </div>
                                      </div>
                                       <div class="form-group">
                                          <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">sub category name</label>
                                          <div class="col-lg-8">
                                              <input type="text" class="form-control" id="subcategory" name="subcategory" placeholder="sub category name" value="<?php echo $editVal['category_name']; ?>">
                                              <p class="help-block"></p>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">sub category link</label>
                                          <div class="col-lg-8">
                                      ...
                                      <div class="form-group">
                                          <label for="inputPassword1" class="col-lg-4 col-sm-4 control-label">	Main description</label>
                                          <div class="col-lg-8">
                                              <textarea  class="form-control" id="maindescription" name="maindescription" placeholder="Main description"> <?php echo $editVal['main_description']; ?> </textarea>
                                          </div>
                                      </div>
                                       <div class="form-group">
        ...
        <script src="js/add_sub_categories_script.js" type="text/javascript"></script>
