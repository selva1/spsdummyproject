                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading">
                                  All Categories List 
						     <a href="add_main_categories.php"><button type="button" class="btn btn-danger button_right" >Add Main Categories</button></a>  <a href="add_sub_categories.php"><button type="button" class="btn btn-danger button_right" style="margin-right: 20px;">Add sub Categories</button></a>
                            </header>
...
<script src="js/pagenation_all_categroyies_list.js" type="text/javascript"></script>
