                        ...
                        <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading">
                                  All Shippment  List 
                                   <!-- <a href="add_shippment.php"><button type="button" class="btn btn-danger" style="float: right; margin-right: 10px;">Add Shippment</button></a>  -->
...
<script src="js/pagenation_all_ship_list.js" type="text/javascript"></script>
