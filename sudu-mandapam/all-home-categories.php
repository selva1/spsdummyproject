                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            All Home categories  List
                            <a href="add_home_categories.php"><button type="button" class="btn btn-danger" style="float: right; margin-right: 10px;">Add Home Category</button></a>
...
<script src="js/pagenation_all_home_categories_list.js" type="text/javascript"></script>
