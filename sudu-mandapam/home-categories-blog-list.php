                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <section class="panel">
						     ...
						     <a href="add_home_categories_blog_list.php"><button type="button" class="btn btn-danger" style="float: right;">Add home categories slider</button></a> 
                            </header>
...
<script src="js/pagenation_all_categories_blog_list.js" type="text/javascript"></script>
...
load(1,search_val,str_check,let_search);
 ...
 <script>
        function deletecategoryblogImgs(delId){
			...
			$.post("get_delete_categories_blog_img.php" , {command:'deletebrandImg',delId:delId} , function(data,status)	{
