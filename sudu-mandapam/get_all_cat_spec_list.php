        ...
        if($numrows>0){
            ...
            <table class="table table-hover">
                ...
                while($result = mysqli_fetch_array($result_final)){
                    ...
                    $specification    = $result['feature_property'];
                    $id               = $result['spec_id'];
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($specification); ?></td>
                        <td> <a href="add-category-specification.php?editId=<?php echo $id; ?>">Edit</a> | <a href="javascript:void(0);" onclick="deleteCatSpecification(<?php echo $id; ?>);">Delete</a></td>
                    </tr>
            ...
            <?php
            echo paginateAllcatSpecificationList($reload, $page, $total_pages, $adjacents,$search_val,$chek_box_val,$let_search,$type_val,$ids_indst);
        } else {
